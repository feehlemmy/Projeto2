...
public class AutorizadorInterceptorProfessor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(request.getSession().getAttribute("professorLogado") == null && request.getSession().getAttribute("escolaLogada") != null) {
			response.sendRedirect("/entrarProfessor");
			return false;
		} else {
			return true;
		}
